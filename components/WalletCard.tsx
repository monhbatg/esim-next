...
export default function WalletCard() {
  ...
  const handleAddBalance = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      setSuccessMessage(
        `Successfully added ${result.currency} ${result.amountAdded.toFixed(2)}! Your new balance is ${result.currency} ${result.balance.toFixed(2)}.`
      );
      setAmount('');
    ...
    <Card>
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-sm text-slate-600 mt-1">Manage your account balance</p>
        </div>
          ...
          <div className="mb-6">
            <div className="relative bg-gradient-to-br from-emerald-500 via-teal-500 to-cyan-500 rounded-2xl p-8 text-white shadow-2xl overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <div className="flex items-center gap-2">
                  <p className="text-sm opacity-90 font-medium">{wallet.currency}</p>
                  ...
                  {amount && !isNaN(parseFloat(amount)) && parseFloat(amount) > 0 && (
                    <div className="mt-2 p-3 bg-emerald-50 border border-emerald-200 rounded-lg">
                      <div className="flex items-center justify-between text-sm">
                        <span className="text-emerald-700 font-medium">New Balance:</span>
                  ...
                  >
                    {isAddingBalance ? (
                      ...
                      <span className="flex items-center justify-center gap-2">
                        ...
                        Add {amount ? formatCurrency(parseFloat(amount), wallet.currency) : 'Funds'}
                      </span>
                    )}
                  </Button>
                </div>
